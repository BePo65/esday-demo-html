# esday-demo-html
This is a minimal demo for how to use the [esday](https://github.com/BePo65/esday) library in a plain html page. It simply displays the current date and a date in 5 days.
